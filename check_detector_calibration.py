...
if detector.serial_number in detector.CALIBRATION_OVERRIDES:
    print("✓ Using EXTERNAL CALIBRATION OVERRIDE")
    ...
    print("⚠ No override found - will use EEPROM calibration")
    print("  (This detector is not in CALIBRATION_OVERRIDES dictionary)")
...
if wavelengths is not None:
    print("✓ Wavelength calibration loaded successfully")
    ...
    print("❌ Failed to load wavelength calibration")
...
if intensity is not None:
    print("✓ Detector readout successful")
    ...
    if intensity.max() > 7500:
        print("  ⚠ WARNING: Signal close to saturation (13-bit max: 8191)")
else:

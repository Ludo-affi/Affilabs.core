...
qc_results = {
    "a": {
        ...
        "p_max_counts": 56519,
        "warnings": [
            "Wide FWHM (159.9nm) - poor sensor contact",
            "P/S ratio (5.35) > 1.15 - polarizer may be inverted",
        ],
    },
    "b": {
        ...
        "warnings": [
            "Wide FWHM (159.9nm) - poor sensor contact",
            "P/S ratio (6.54) > 1.15 - polarizer may be inverted",
        ],
    },
    "c": {
        ...
        "warnings": [
            "Wide FWHM (159.9nm) - poor sensor contact",
            "P/S ratio (6.73) > 1.15 - polarizer may be inverted",
        ],
    },
    "d": {
        ...
        "warnings": [
            "Wide FWHM (159.9nm) - poor sensor contact",
            "P/S ratio (6.20) > 1.15 - polarizer may be inverted",
        ],
    },
}
...
fig.suptitle(
    "Calibration Results - CRITICAL: P/S Ratios Inverted (P > S)",
    fontsize=16,
    fontweight="bold",
    color="red",
)
...
summary_text += "  Polarizer: S=120deg, P=60deg (INVERTED)\n\n"

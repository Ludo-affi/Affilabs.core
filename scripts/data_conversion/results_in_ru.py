...
for method, channels in results.items():
    ...
    print(
        f"{method:<30} {ch_a_ru:<10.1f} {ch_b_ru:<10.1f} {ch_c_ru:<10.1f} {ch_d_ru:<10.1f} {avg_ru:<10.1f}",
    )
...
print("   - Channel A: 449 RU (112x worse than 4 RU)")
print("   - Average: 595 RU (149x worse than 4 RU)")
print()

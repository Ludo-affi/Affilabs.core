...
def get_cursor_style():
    ...
    from pyqtgraph import mkPen
    return {
        'left_cursor': mkPen(color=CURSOR_COLOR, width=2, style=pg.QtCore.Qt.PenStyle.DashLine),
        'right_cursor': mkPen(color=CURSOR_COLOR, width=2, style=pg.QtCore.Qt.PenStyle.DashLine),
    }

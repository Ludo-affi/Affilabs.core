...
class Ui_KAKDWizardDialog(object):
    def setupUi(self, KAKDWizardDialog):
        if not KAKDWizardDialog.objectName():
            KAKDWizardDialog.setObjectName(u"KAKDWizardDialog")
        ...
        sizePolicy1.setHeightForWidth(self.label_cur_info.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHeightForWidth(self.affinity_result.sizePolicy().hasHeightForWidth())
        ...
        self.layout_constant.setObjectName(u"layout_constant")
        ...
        self.lb_KD.setObjectName(u"lb_KD")
        ...
        self.lb_Rmax.setObjectName(u"lb_Rmax")
        ...
        self.lb_ka.setObjectName(u"lb_ka")
        ...
        self.lb_r_sq.setObjectName(u"lb_r_sq")
...
"}")
    ...
    def retranslateUi(self, KAKDWizardDialog):
        KAKDWizardDialog.setWindowTitle(QCoreApplication.translate("KAKDWizardDialog", u"Kinetic Wizard", None))
        self.label_cur_info.setText("")
        ___qtablewidgetitem = self.table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("KAKDWizardDialog", u"Cycle", None));
        ___qtablewidgetitem1 = self.table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("KAKDWizardDialog", u"Conc'n (nM)", None));
        ___qtablewidgetitem2 = self.table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("KAKDWizardDialog", u"Association\n"
"Shift (RU)", None));
        ___qtablewidgetitem3 = self.table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("KAKDWizardDialog", u"Dissociation\n"
"Shift (RU)", None));
        self.groupBox_2.setTitle(QCoreApplication.translate("KAKDWizardDialog", u"Channel", None))
        self.ch_a.setText(QCoreApplication.translate("KAKDWizardDialog", u"A", None))
        self.ch_b.setText(QCoreApplication.translate("KAKDWizardDialog", u"B", None))
        self.ch_c.setText(QCoreApplication.translate("KAKDWizardDialog", u"C", None))
        self.ch_d.setText(QCoreApplication.translate("KAKDWizardDialog", u"D", None))
        self.affinity_result.setTitle(QCoreApplication.translate("KAKDWizardDialog", u"Results", None))
        self.label.setText(QCoreApplication.translate("KAKDWizardDialog", u"KD:", None))
        self.lb_KD.setText("")
        self.label_2.setText(QCoreApplication.translate("KAKDWizardDialog", u"<html><head/><body><p>R<span style=\" vertical-align:sub;\">MAX</span>:</p></body></html>", None))
        self.lb_Rmax.setText("")
        self.label_4.setText(QCoreApplication.translate("KAKDWizardDialog", u"<html><head/><body><p>ka:</p></body></html>", None))
        self.lb_ka.setText("")
        self.label_3.setText(QCoreApplication.translate("KAKDWizardDialog", u"kd:", None))
        self.lb_kd.setText("")
        self.label_5.setText(QCoreApplication.translate("KAKDWizardDialog", u"<html><head/><body><p>R<span style=\" vertical-align:super;\">2</span>:</p></body></html>", None))
        self.lb_r_sq.setText("")
        self.btn_kd.setText(QCoreApplication.translate("KAKDWizardDialog", u"Calculate\n"
"Results", None))
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("KAKDWizardDialog", u"Export Segment Data", None))

...
class Ui_Device(object):
    def setupUi(self, Device):
        ...
        self.add_ctrl.setObjectName(u"add_ctrl")
        self.add_ctrl.setMinimumSize(QSize(120, 25))
        self.add_ctrl.setStyleSheet(u"QPushButton {\n"
"		\n"
...
"}")
        ...
        sizePolicy.setHeightForWidth(self.kinetic_frame.sizePolicy().hasHeightForWidth())
        ...
        self.add_knx.setObjectName(u"add_knx")
        self.add_knx.setMinimumSize(QSize(130, 25))
        self.add_knx.setStyleSheet(u"QPushButton {\n"
"		\n"
"		background-color: rgb(230, 230, 230);\n"
"	    border: 1px solid rgb(171, 171, 171); \n"
"		border-radius: 3px;\n"
...
"}")
        ...
        self.add_pump.setObjectName(u"add_pump")
        self.add_pump.setMinimumSize(QSize(120, 25))
        self.add_pump.setStyleSheet(u"QPushButton {\n"
"		\n"
"		background-color: rgb(230, 230, 230);\n"
"	    border: 1px solid rgb(171, 171, 171); \n"
"		border-radius: 3px;\n"
...
"}")
    ...
    def retranslateUi(self, Device):
        ...
        self.add_ctrl.setText(QCoreApplication.translate("Device", u"Add SPR Device", None))
        self.add_knx.setText(QCoreApplication.translate("Device", u"Add Kinetic Device", None))
        self.add_pump.setText(QCoreApplication.translate("Device", u"Add Pump Device", None))
    # retranslateUi

...
class PipelineRegistry:
    ...
    def register(self, pipeline_id: str, pipeline_class: type[ProcessingPipeline]) -> None:
    ...
    def get_pipeline(self, pipeline_id: str, config: Optional[Dict[str, Any]] = None) -> ProcessingPipeline:
    ...
    def set_active_pipeline(self, pipeline_id: str, config: Optional[Dict[str, Any]] = None) -> None:
    ...
    @property
    def active_pipeline_id(self) -> Optional[str]:

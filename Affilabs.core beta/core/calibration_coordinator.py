...
class CalibrationCoordinator(QObject):
    ...
    def _save_calibration_to_device_config(self, calibration_data: dict) -> None:
        """Save calibration data to device config."""

...
class AffiniteAppSimple(QApplication):
    """Simplified main application using state machine architecture."""
    ...
    def __init__(self) -> None:
        ...
        logger.info(f"========== Starting Affinite Instruments Application (Simple) ==========")
        logger.info(f"Version {SW_VERSION}")

        # Show main window
        self.main_window.show()

        logger.info("AffiniteApp (Simple) initialized")

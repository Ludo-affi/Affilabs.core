...
class Ui_KDWizardDialog(object):
    def setupUi(self, KDWizardDialog):
        if not KDWizardDialog.objectName():
            KDWizardDialog.setObjectName(u"KDWizardDialog")
        ...
        self.add_shifts.setObjectName(u"add_shifts")
        font3 = QFont()
        ...
        self.btn_kd.setObjectName(u"btn_kd")
        ...
        self.btn_kd.setStyleSheet(u"QPushButton {\n"
"		\n"
...
"}")
        ...
        self.fit_linear.setObjectName(u"fit_linear")
        ...
        self.fit_affinity.setObjectName(u"fit_affinity")
        ...
        self.chk_fitting_curve.setObjectName(u"chk_fitting_curve")
        sizePolicy.setHeightForWidth(self.chk_fitting_curve.sizePolicy().hasHeightForWidth())
        ...
        self.affinity_result.setObjectName(u"affinity_result")
        ...
        self.rmax_val.setObjectName(u"rmax_val")
        ...
        self.kd_val.setObjectName(u"kd_val")
        ...
        self.chi_sq_val.setObjectName(u"chi_sq_val")
        ...
        self.lin_eqn.setObjectName(u"lin_eqn")
        ...
        self.r_sq_val.setObjectName(u"r_sq_val")
...
"}")
        icon = QIcon()
        icon.addFile(u":/img/img/save.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, KDWizardDialog):
        KDWizardDialog.setWindowTitle(QCoreApplication.translate("KDWizardDialog", u"Fitting Wizard", None))
        self.label_cur_info.setText("")
        ___qtablewidgetitem = self.table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("KDWizardDialog", u"Cycle", None));
        ___qtablewidgetitem1 = self.table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("KDWizardDialog", u"Conc'n (nM)", None));
        ___qtablewidgetitem2 = self.table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("KDWizardDialog", u"Shift (RU)", None));
        ___qtablewidgetitem3 = self.table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("KDWizardDialog", u"Residual (RU)", None));
        self.add_shifts.setText(QCoreApplication.translate("KDWizardDialog", u"Cumulative Shift Values", None))
        self.btn_kd.setText(QCoreApplication.translate("KDWizardDialog", u"Calculate KD", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("KDWizardDialog", u"Channel", None))
        self.ch_a.setText(QCoreApplication.translate("KDWizardDialog", u"A", None))
        self.ch_b.setText(QCoreApplication.translate("KDWizardDialog", u"B", None))
        self.ch_c.setText(QCoreApplication.translate("KDWizardDialog", u"C", None))
        self.ch_d.setText(QCoreApplication.translate("KDWizardDialog", u"D", None))
        self.groupBox.setTitle(QCoreApplication.translate("KDWizardDialog", u"Fitting Model", None))
        self.fit_linear.setText(QCoreApplication.translate("KDWizardDialog", u"Linear", None))
        self.fit_affinity.setText(QCoreApplication.translate("KDWizardDialog", u"Affinity", None))
        self.chk_fitting_curve.setText(QCoreApplication.translate("KDWizardDialog", u"Plot Fitting Curve", None))
        self.affinity_result.setTitle(QCoreApplication.translate("KDWizardDialog", u"Affinity Result", None))
        self.label_6.setText(QCoreApplication.translate("KDWizardDialog", u"<html><head/><body><p>R<span style=\" vertical-align:sub;\">MAX</span>:</p></body></html>", None))
        self.rmax_val.setText("")
        self.label.setText(QCoreApplication.translate("KDWizardDialog", u"KD:", None))
        self.kd_val.setText("")
        self.label_3.setText(QCoreApplication.translate("KDWizardDialog", u"<html><head/><body><p>\u03c7<span style=\" vertical-align:super;\">2</span>:</p></body></html>", None))
        self.chi_sq_val.setText("")
        self.p_val.setText(QCoreApplication.translate("KDWizardDialog", u"p:", None))
        self.linear_result.setTitle(QCoreApplication.translate("KDWizardDialog", u"Linear Result", None))
        self.label_4.setText(QCoreApplication.translate("KDWizardDialog", u"Y = ", None))
        self.lin_eqn.setText("")
        self.label_5.setText(QCoreApplication.translate("KDWizardDialog", u"<html><head/><body><p>R<span style=\" vertical-align:super;\">2</span>:</p></body></html>", None))
        self.r_sq_val.setText("")
#if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(QCoreApplication.translate("KDWizardDialog", u"Export Segment Data", None))

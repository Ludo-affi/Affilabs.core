...
class GraphicControlTabBuilder:
    ...
    def _build_data_filtering(self, tab_layout: QVBoxLayout):
        ...
        self.sidebar.median_filter_radio.setToolTip("Fast median filter - good for live data (preserves sharp features)")
        ...
        self.sidebar.kalman_filter_radio.setStyleSheet(self.sidebar.median_filter_radio.styleSheet())
        self.sidebar.kalman_filter_radio.setToolTip("Kalman filter - optimal for historical data (smooth trajectories, 2-3x better SNR)")

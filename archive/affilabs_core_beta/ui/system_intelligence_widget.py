...
from core.system_intelligence import IssueSeverity, SystemState, get_system_intelligence
...
class SystemIntelligenceWidget(QWidget):
    ...
    def _on_diagnose_clicked(self):
        ...
        logger.info("🔍 Running manual system diagnosis...")
        self._update_display()
        ...
        if recommendations:
            ...
            logger.info("✅ No maintenance recommendations")

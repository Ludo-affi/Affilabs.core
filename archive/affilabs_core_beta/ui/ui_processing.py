...
class Ui_Processing(object):
    def setupUi(self, Processing):
        if not Processing.objectName():
            Processing.setObjectName(u"Processing")
        ...
        self.verticalSpacer = QSpacerItem(20, 393, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.sensorgram_controls.setObjectName(u"sensorgram_controls")
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.sensorgram_controls.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.reference_channel_btn.sizePolicy().hasHeightForWidth())
        self.reference_channel_btn.setSizePolicy(sizePolicy2)
        self.reference_channel_btn.setFont(font)
        self.reference_channel_btn.setStyleSheet(u"QPushButton {\n"
"		\n"
...
"}")
        ...
        self.groupBox_6.setFont(font_groupbox)
...
"border: 2px solid rgb(100, 100, 100);")
        ...
        sizePolicy2.setHeightForWidth(self.reset_segment_btn.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        self.export_raw_data_btn.setObjectName(u"export_raw_data_btn")
        self.export_raw_data_btn.setGeometry(QRect(470, 80, 30, 30))
        sizePolicy2.setHeightForWidth(self.export_raw_data_btn.sizePolicy().hasHeightForWidth())
        ...
        self.export_raw_data_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/img/img/save.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.import_raw_data_btn.setObjectName(u"import_raw_data_btn")
        self.import_raw_data_btn.setGeometry(QRect(430, 80, 30, 30))
        sizePolicy2.setHeightForWidth(self.import_raw_data_btn.sizePolicy().hasHeightForWidth())
        ...
        self.import_raw_data_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/img/img/folder.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.import_sens_btn.setObjectName(u"import_sens_btn")
        self.import_sens_btn.setGeometry(QRect(390, 80, 30, 30))
        sizePolicy2.setHeightForWidth(self.import_sens_btn.sizePolicy().hasHeightForWidth())
        ...
        self.import_sens_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/img/img/import.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.curr_seg_box.setObjectName(u"curr_seg_box")
...
"border-radius: 2px;")
        ...
        self.save_segment_btn.setStyleSheet(u"QPushButton {\n"
"		background-color: rgb(230, 230, 230);\n"
"	    border: 1px solid rgb(171, 171, 171); \n"
"		border-radius: 3px;\n"
"}\n"
...
"}")
        ...
        self.new_segment_btn.setStyleSheet(u"QPushButton {\n"
"		\n"
"		background-color: rgb(230, 230, 230);\n"
"	    border: 1px solid rgb(171, 171, 171); \n"
"		border-radius: 3px;\n"
...
"}")
        ...
        self.align_seg_btn.setObjectName(u"align_seg_btn")
        self.align_seg_btn.setMinimumSize(QSize(0, 45))
        self.align_seg_btn.setFont(font)
        self.align_seg_btn.setStyleSheet(u"QPushButton {\n"
"		\n"
"		background-color: rgb(230, 230, 230);\n"
"	    border: 1px solid rgb(171, 171, 171); \n"
"		border-radius: 3px;\n"
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.delete_row_btn.sizePolicy().hasHeightForWidth())
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/img/img/trash.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon5 = QIcon()
        icon5.addFile(u":/img/img/undo.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.export_table_btn.setObjectName(u"export_table_btn")
        self.export_table_btn.setGeometry(QRect(460, 10, 30, 30))
        sizePolicy2.setHeightForWidth(self.export_table_btn.sizePolicy().hasHeightForWidth())
        ...
        self.export_table_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        ...
        self.import_table_btn.setObjectName(u"import_table_btn")
        self.import_table_btn.setGeometry(QRect(420, 10, 30, 30))
        sizePolicy2.setHeightForWidth(self.import_table_btn.sizePolicy().hasHeightForWidth())
        ...
        self.import_table_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
    ...
    def retranslateUi(self, Processing):
        Processing.setWindowTitle(QCoreApplication.translate("Processing", u"Form", None))
        self.label_3.setText(QCoreApplication.translate("Processing", u"Control Panel", None))
        self.groupBox.setTitle(QCoreApplication.translate("Processing", u"Display", None))
        self.segment_A.setText(QCoreApplication.translate("Processing", u"A", None))
        self.segment_B.setText(QCoreApplication.translate("Processing", u"B", None))
        self.segment_C.setText(QCoreApplication.translate("Processing", u"C", None))
        self.segment_D.setText(QCoreApplication.translate("Processing", u"D", None))
        self.reference_channel_btn.setText(QCoreApplication.translate("Processing", u"SPR Settings", None))
        self.groupBox_6.setTitle(QCoreApplication.translate("Processing", u"Cycle Cursors", None))
        self.label_14.setText(QCoreApplication.translate("Processing", u"Start Cursor:", None))
        self.label_16.setText(QCoreApplication.translate("Processing", u"End Cursor:", None))
        self.label_9.setText(QCoreApplication.translate("Processing", u"s", None))
        self.label_10.setText(QCoreApplication.translate("Processing", u"s", None))
        self.exp_clock.setText(QCoreApplication.translate("Processing", u"HH.MM.SS", None))
        self.label_19.setText(QCoreApplication.translate("Processing", u"Experiment Time:", None))
        self.label_6.setText("")
        self.label_7.setText("")
#if QT_CONFIG(tooltip)
        self.reset_segment_btn.setToolTip(QCoreApplication.translate("Processing", u"Clear All Data", None))
#endif // QT_CONFIG(tooltip)
        self.reset_segment_btn.setText("")
#if QT_CONFIG(tooltip)
        self.export_raw_data_btn.setToolTip(QCoreApplication.translate("Processing", u"Export Raw Data", None))
#endif // QT_CONFIG(tooltip)
        self.export_raw_data_btn.setText("")
#if QT_CONFIG(tooltip)
        self.import_raw_data_btn.setToolTip(QCoreApplication.translate("Processing", u"Import Raw Data", None))
#endif // QT_CONFIG(tooltip)
        self.import_raw_data_btn.setText("")
#if QT_CONFIG(tooltip)
        self.import_sens_btn.setToolTip(QCoreApplication.translate("Processing", u"Load Sensorgram Data", None))
#endif // QT_CONFIG(tooltip)
        self.import_sens_btn.setText("")
        self.label_4.setText(QCoreApplication.translate("Processing", u"Cycle of Interest", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("Processing", u"Display", None))
        self.SOI_A.setText(QCoreApplication.translate("Processing", u"A", None))
        self.SOI_B.setText(QCoreApplication.translate("Processing", u"B", None))
        self.SOI_C.setText(QCoreApplication.translate("Processing", u"C", None))
        self.SOI_D.setText(QCoreApplication.translate("Processing", u"D", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("Processing", u"Cycle Shift", None))
        self.unit_a.setText(QCoreApplication.translate("Processing", u"RU", None))
        self.unit_b.setText(QCoreApplication.translate("Processing", u"RU", None))
        self.unit_c.setText(QCoreApplication.translate("Processing", u"RU", None))
        self.unit_d.setText(QCoreApplication.translate("Processing", u"RU", None))
        self.shift_A.setText(QCoreApplication.translate("Processing", u"-", None))
        self.shift_B.setText(QCoreApplication.translate("Processing", u"-", None))
        self.shift_C.setText(QCoreApplication.translate("Processing", u"-", None))
        self.shift_D.setText(QCoreApplication.translate("Processing", u"-", None))
        self.label_20.setText(QCoreApplication.translate("Processing", u"Shift A:", None))
...
"Cycle", None))
        self.new_segment_btn.setText(QCoreApplication.translate("Processing", u"Start From\n"
"Last Cycle", None))
        self.align_seg_btn.setText(QCoreApplication.translate("Processing", u"Send to\n"
"Data Analysis", None))
#if QT_CONFIG(tooltip)
        self.delete_row_btn.setToolTip(QCoreApplication.translate("Processing", u"Delete Cycle", None))
#endif // QT_CONFIG(tooltip)
        self.delete_row_btn.setText("")
#if QT_CONFIG(tooltip)
        self.add_row_btn.setToolTip(QCoreApplication.translate("Processing", u"Restore Last Deleted", None))
#endif // QT_CONFIG(tooltip)
        self.add_row_btn.setText("")
#if QT_CONFIG(tooltip)
        self.export_table_btn.setToolTip(QCoreApplication.translate("Processing", u"Export Data Table", None))
#endif // QT_CONFIG(tooltip)
        self.export_table_btn.setText("")
#if QT_CONFIG(tooltip)
        self.import_table_btn.setToolTip(QCoreApplication.translate("Processing", u"Import Data Table", None))
#endif // QT_CONFIG(tooltip)
        self.import_table_btn.setText("")
        self.table_toggle.setText(QCoreApplication.translate("Processing", u"Cycle Data Table", None))
        ___qtablewidgetitem = self.data_table.horizontalHeaderItem(1)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Processing", u"Start", None));
        ___qtablewidgetitem1 = self.data_table.horizontalHeaderItem(2)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Processing", u"End", None));
        ___qtablewidgetitem2 = self.data_table.horizontalHeaderItem(3)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Processing", u"Shift A", None));
        ___qtablewidgetitem3 = self.data_table.horizontalHeaderItem(4)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Processing", u"Shift B", None));
        ___qtablewidgetitem4 = self.data_table.horizontalHeaderItem(5)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Processing", u"Shift C", None));
        ___qtablewidgetitem5 = self.data_table.horizontalHeaderItem(6)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Processing", u"Shift D", None));
        ___qtablewidgetitem6 = self.data_table.horizontalHeaderItem(7)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("Processing", u"Ref", None));
        ___qtablewidgetitem7 = self.data_table.horizontalHeaderItem(8)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Processing", u"Note", None));
    # retranslateUi

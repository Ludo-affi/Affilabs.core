...
if __name__ == "__main__":
    ...
    print("  Spectrum size: 1797 pixels")
    ...
    print("Context:")
    print("=" * 60)
    print("Per cycle breakdown (4 channels):")
    print("  LED commands:      ~600 ms  (turn on)")
    print("  Integration:       ~100 ms  (varies)")
    print("  USB transfers:      ~48 ms  (4 × 12ms)")
    print(f"  Processing:         ~{seq_mean:.1f} ms  (current)")
    print("  LED off:            ~50 ms   (turn off)")
    print("  ─────────────────────────────")
    ...
    print(
        f"  Savings:            ~{savings:.1f} ms ({savings/(600+100+48+seq_mean+50)*100:.1f}% of total)",
    )
    print()

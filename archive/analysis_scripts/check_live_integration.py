...
def check_integration_times():
    ...
    try:
        ...
        print("\n🚀 LIVE MODE BOOST:")
        if hasattr(sm, 'live_integration_per_channel') and sm.live_integration_per_channel:
        ...
        if hasattr(sm, 'data_acquisition') and sm.data_acquisition:
            ...
            if hasattr(daq, 'data_acquisition') and daq.data_acquisition:
                ...
                if hasattr(actual_daq, 'integration_per_channel') and actual_daq.integration_per_channel:

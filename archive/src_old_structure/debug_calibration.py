...
for i, line in enumerate(lines):
    ...
    # Before dark noise
        ...
        "Step 2: Measure dark noise AT MAX INTEGRATION TIME" in line
        and "# Step 2:" in line
    ):
        insertions.append(
            (i, '        print("\\n🔍 DEBUG: About to measure dark noise...")\n'),
        )

    # After dark noise
    elif (
        "Dark noise measurement complete (single measurement for all channels)" in line
    ):
        insertions.append(
            (i + 1, '        print(f"\\n🔍 DEBUG: Dark noise complete")\n'),
        )
    ...
    # Before P-ref measurement
        ...
        insertions.append(
            (
                i,
                '        print("\\n🔍 DEBUG: About to measure P-mode reference signals...")\n',
            ),
        )
...
print(f"✅ Added {len(insertions)} debug points to calibration flow")

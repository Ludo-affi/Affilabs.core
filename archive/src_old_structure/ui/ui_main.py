...
from PySide6.QtGui import QBrush, QColor, QCursor, QFont, QIcon, QPalette, QPixmap
...
class Ui_mainWindow:
    def setupUi(self, mainWindow):
        ...
        self.horizontalLayout_4.setContentsMargins(
            ...
            0,
            0,
        )  # Left margin to align with main page
        ...
        font_power = QFont()
        font_power.setFamilies(["Segoe UI"])
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.data_processing_btn.setText(
            QCoreApplication.translate("mainWindow", "Processing", None),
        )

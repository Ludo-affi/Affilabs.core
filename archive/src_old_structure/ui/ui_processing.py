...
class Ui_Processing:
    def setupUi(self, Processing):
        ...
        self.label_cycle_time.setObjectName("label_cycle_time")
        ...
        self.current_cycle_time.setObjectName("current_cycle_time")
    ...
    def retranslateUi(self, Processing):
        ...
        self.groupBox_4.setTitle(
            QCoreApplication.translate("Processing", "Cycle Settings", None),
        )

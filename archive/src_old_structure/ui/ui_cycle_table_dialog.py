...
from PySide6.QtWidgets import (QAbstractScrollArea, QApplication, QDialog, QFrame,
    QGraphicsView, QHeaderView, QPushButton, QSizePolicy,
    QTableWidget, QTableWidgetItem, QVBoxLayout, QWidget)
from . import ai_rc

class Ui_CycleTableDialog(object):
    def setupUi(self, CycleTableDialog):
        if not CycleTableDialog.objectName():
            CycleTableDialog.setObjectName(u"CycleTableDialog")
        ...
        sizePolicy1.setHeightForWidth(self.delete_row_btn.sizePolicy().hasHeightForWidth())
...
"}")
        icon = QIcon()
        icon.addFile(u":/img/img/trash.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/img/img/undo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.data_table.horizontalHeader().setProperty(u"showSortIndicator", False)
        ...
        self.data_table.verticalHeader().setProperty(u"showSortIndicator", False)
    ...
    def retranslateUi(self, CycleTableDialog):
        CycleTableDialog.setWindowTitle(QCoreApplication.translate("CycleTableDialog", u"Cycle Data Table", None))
#if QT_CONFIG(tooltip)
        self.delete_row_btn.setToolTip(QCoreApplication.translate("CycleTableDialog", u"Delete Cycle", None))
#endif // QT_CONFIG(tooltip)
        self.delete_row_btn.setText("")
#if QT_CONFIG(tooltip)
        self.add_row_btn.setToolTip(QCoreApplication.translate("CycleTableDialog", u"Restore Last Deleted", None))
#endif // QT_CONFIG(tooltip)
        self.add_row_btn.setText("")
        self.table_toggle.setText(QCoreApplication.translate("CycleTableDialog", u"Cycle Data Table", None))
        ___qtablewidgetitem = self.data_table.horizontalHeaderItem(1)
        ___qtablewidgetitem.setText(QCoreApplication.translate("CycleTableDialog", u"Start", None));
        ___qtablewidgetitem1 = self.data_table.horizontalHeaderItem(2)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("CycleTableDialog", u"End", None));
        ___qtablewidgetitem2 = self.data_table.horizontalHeaderItem(3)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("CycleTableDialog", u"Shift A", None));
        ___qtablewidgetitem3 = self.data_table.horizontalHeaderItem(4)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("CycleTableDialog", u"Shift B", None));
        ___qtablewidgetitem4 = self.data_table.horizontalHeaderItem(5)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("CycleTableDialog", u"Shift C", None));
        ___qtablewidgetitem5 = self.data_table.horizontalHeaderItem(6)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("CycleTableDialog", u"Shift D", None));
        ___qtablewidgetitem6 = self.data_table.horizontalHeaderItem(7)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("CycleTableDialog", u"Ref", None));
        ___qtablewidgetitem7 = self.data_table.horizontalHeaderItem(8)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("CycleTableDialog", u"Note", None));
    # retranslateUi

...
class Ui_FormAnalysis:
    def setupUi(self, FormAnalysis):
        ...
        self.stack_graph.setObjectName("stack_graph")
        ...
        self.fit_wizard_btn.setObjectName("fit_wizard_btn")
        ...
        self.fit_wizard_btn.setStyleSheet(
            "QPushButton {\n"
            "		\n"
        ...
        self.kin_wizard_btn.setObjectName("kin_wizard_btn")
        ...
        self.kin_wizard_btn.setStyleSheet(
            "QPushButton {\n"
            "		\n"
            "		background-color: rgb(230, 230, 230);\n"
            "	    border: 1px solid rgb(171, 171, 171); \n"
        ...
        self.file_ctrls.setObjectName("file_ctrls")
        ...
        self.reset_analysis_btn.setObjectName("reset_analysis_btn")
        ...
        self.reset_analysis_btn.setStyleSheet(
            "QPushButton{\n"
            "	border: none;\n"
            "	background: none;\n"
            "}\n"
        ...
        self.bottom_horizontal.setObjectName("bottom_horizontal")
        self.SOI_Frame = QFrame(FormAnalysis)
        self.SOI_Frame.setObjectName("SOI_Frame")
        ...
        self.seg_select.setObjectName("seg_select")

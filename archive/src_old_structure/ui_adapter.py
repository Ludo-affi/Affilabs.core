...
class UIAdapter(QObject):
    ...
    def set_power_state(self, state: str) -> None:
        ...
        """
        self.ui._set_power_button_state(state)
        self.ui._update_power_button_style()
    ...
    def update_device_status(
        ...
        """
        self.ui._set_subunit_status(subunit, ready, details)
    ...
    def set_recording_state(self, is_recording: bool) -> None:
        ...
        """
        self.ui.update_recording_state(is_recording)
    ...
    def update_timeline_graph_data(self, channel_idx: int, x_data, y_data) -> None:
        ...
        """
        if 0 <= channel_idx < len(self.ui.full_timeline_graph.curves):
            self.ui.full_timeline_graph.curves[channel_idx].setData(x_data, y_data)
    ...
    def update_cycle_graph_data(self, channel_idx: int, x_data, y_data) -> None:
        ...
        """
        if 0 <= channel_idx < len(self.ui.cycle_of_interest_graph.curves):
            self.ui.cycle_of_interest_graph.curves[channel_idx].setData(x_data, y_data)
    ...
    def clear_graphs(self) -> None:
        ...
        for curve in self.ui.full_timeline_graph.curves:
            curve.setData([], [])
        for curve in self.ui.cycle_of_interest_graph.curves:
            curve.setData([], [])
    ...
    def set_channel_visibility(self, channel_idx: int, visible: bool) -> None:
        ...
        """
        if 0 <= channel_idx < len(self.ui.full_timeline_graph.curves):
            self.ui.full_timeline_graph.curves[channel_idx].setVisible(visible)
            self.ui.cycle_of_interest_graph.curves[channel_idx].setVisible(visible)

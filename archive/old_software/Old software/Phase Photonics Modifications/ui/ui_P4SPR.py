...
class Ui_P4SPR_2(object):
    def setupUi(self, P4SPR_2):
        if not P4SPR_2.objectName():
            P4SPR_2.setObjectName(u"P4SPR_2")
        ...
        self.P4SPR.setObjectName(u"P4SPR")
        ...
        self.P4SPR.setStyleSheet(u"QGroupBox#P4SPR::title{\n"
"\n"
...
"}")
    ...
    def retranslateUi(self, P4SPR_2):
        P4SPR_2.setWindowTitle(QCoreApplication.translate("P4SPR_2", u"Form", None))
        self.P4SPR.setTitle(QCoreApplication.translate("P4SPR_2", u"SPR", None))
#if QT_CONFIG(tooltip)
        self.disconnect_btn.setToolTip(QCoreApplication.translate("P4SPR_2", u"Disconnect P4SPR", None))
#endif // QT_CONFIG(tooltip)
        self.disconnect_btn.setText("")
        self.quick_calibrate_btn.setText(QCoreApplication.translate("P4SPR_2", u"Calibrate", None))
        self.temp1.setText("")
        self.label_7.setText("")
        self.label_8.setText(QCoreApplication.translate("P4SPR_2", u"<html><head/><body><p>Temp:</p></body></html>", None))
    # retranslateUi

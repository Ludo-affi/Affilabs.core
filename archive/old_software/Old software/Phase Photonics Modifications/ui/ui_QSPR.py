...
class Ui_QSPR(object):
    def setupUi(self, QSPR):
        if not QSPR.objectName():
            QSPR.setObjectName(u"QSPR")
        QSPR.resize(260, 110)
        ...
        self.QSPR_display.setObjectName(u"QSPR_display")
        ...
        self.QSPR_display.setStyleSheet(u"QGroupBox#QSPR_display::title{\n"
"\n"
...
"}")
        icon = QIcon()
        icon.addFile(u":/img/img/power.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/img/img/disconnect.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.cartridge_display.setObjectName(u"cartridge_display")
...
"}")
        ...
        self.adj_up_btn.setObjectName(u"adj_up_btn")
        ...
        self.adj_up_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/img/img/adj_up.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.adj_down_btn.setObjectName(u"adj_down_btn")
        self.adj_down_btn.setGeometry(QRect(155, 75, 20, 20))
        sizePolicy1.setHeightForWidth(self.adj_down_btn.sizePolicy().hasHeightForWidth())
        ...
        self.adj_down_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/img/img/adj_down.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.crt_down_btn.setObjectName(u"crt_down_btn")
        self.crt_down_btn.setGeometry(QRect(50, 60, 35, 35))
        sizePolicy1.setHeightForWidth(self.crt_down_btn.sizePolicy().hasHeightForWidth())
        ...
        self.crt_down_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/img/img/crt_down.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.crt_up_btn.setObjectName(u"crt_up_btn")
        ...
        self.crt_up_btn.setStyleSheet(u"QPushButton{\n"
"	border: none;\n"
"	background: none;\n"
"}\n"
"\n"
...
"}")
        icon5 = QIcon()
        icon5.addFile(u":/img/img/crt_up.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, QSPR):
        QSPR.setWindowTitle(QCoreApplication.translate("QSPR", u"Form", None))
        self.QSPR_display.setTitle(QCoreApplication.translate("QSPR", u"QSPR", None))
#if QT_CONFIG(tooltip)
        self.shutdown_btn.setToolTip(QCoreApplication.translate("QSPR", u"Power Off QSPR", None))
#endif // QT_CONFIG(tooltip)
        self.shutdown_btn.setText("")
#if QT_CONFIG(tooltip)
        self.disconnect_btn.setToolTip(QCoreApplication.translate("QSPR", u"Disconnect QSPR", None))
#endif // QT_CONFIG(tooltip)
        self.disconnect_btn.setText("")
        self.temp1.setText(QCoreApplication.translate("QSPR", u"##.#", None))
        self.label_7.setText("")
        self.label.setText(QCoreApplication.translate("QSPR", u"Cartridge\n"
"Controls", None))
        self.label_3.setText(QCoreApplication.translate("QSPR", u"Fine\n"
"Adjust", None))
#if QT_CONFIG(tooltip)
        self.quick_calibrate_btn.setToolTip(QCoreApplication.translate("QSPR", u"Calibrate QSPR", None))
#endif // QT_CONFIG(tooltip)
        self.quick_calibrate_btn.setText(QCoreApplication.translate("QSPR", u"Calibrate", None))
#if QT_CONFIG(tooltip)
        self.adj_up_btn.setToolTip(QCoreApplication.translate("QSPR", u"Adjust Up", None))
#endif // QT_CONFIG(tooltip)
        self.adj_up_btn.setText("")
#if QT_CONFIG(tooltip)
        self.adj_down_btn.setToolTip(QCoreApplication.translate("QSPR", u"Adjust Down", None))
#endif // QT_CONFIG(tooltip)
        self.adj_down_btn.setText("")
#if QT_CONFIG(tooltip)
        self.crt_down_btn.setToolTip(QCoreApplication.translate("QSPR", u"Cartrdige Down", None))
#endif // QT_CONFIG(tooltip)
        self.crt_down_btn.setText("")
#if QT_CONFIG(tooltip)
        self.crt_up_btn.setToolTip(QCoreApplication.translate("QSPR", u"Cartridge Up", None))
#endif // QT_CONFIG(tooltip)

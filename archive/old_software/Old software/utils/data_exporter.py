...
class DataExporter:
    ...
    def __init__(self, base_dir: str | Path, experiment_name: str):
        """Initialize exporter.
    ...
    def _record_export(self, filepath: Path, format: ExportFormat, row_count: int):
    ...
    def export_raw_data(
        ...
        if references is None:
            ...
            if min_array_len == 0:
                raise ValueError("Cannot export: no data in lambda_values")
    ...
    def export_filtered_data(self, data: dict, metadata=None):
        ...
        if not is_valid:
            ...
            raise ValueError(f"Invalid filtered data: {error_msg}")
    ...
    def export_segments(self, segments: list, value_list: dict, ts_list: dict):
    ...
    def export_temperature_log(self, temp_log: pd.DataFrame):
    ...
    def save_metadata(self, device_config: dict, settings: dict):

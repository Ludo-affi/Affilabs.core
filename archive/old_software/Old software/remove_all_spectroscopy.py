...
for i, line in enumerate(lines):
    if (
        "hasattr(self.main_window, 'spectroscopy') and hasattr(self.main_window.spectroscopy"
        in line
    ):
        ...
        i > 0
        and "spectroscopy.set_advanced_smoothing" in line
        and "hasattr" in lines[i - 1]
    ):

...
class Ui_Spectroscopy:
    def setupUi(self, Spectroscopy):
        ...
        self.new_ref_btn.setObjectName("new_ref_btn")
        ...
        self.new_ref_btn.setStyleSheet(
            "QPushButton {\n"
            "		\n"
        ...
        self.full_calibrate_btn.setStyleSheet(
            "QPushButton {\n"
            "		\n"
            "		background-color: rgb(230, 230, 230);\n"
            "	    border: 1px solid rgb(171, 171, 171); \n"
        ...
        self.polarization.setStyleSheet("")
        ...
        self.led_mode.addItem("")
        self.led_mode.setObjectName("led_mode")
        ...
        self.single_LED.setObjectName("single_LED")
    ...
    def retranslateUi(self, Spectroscopy):
        ...
        self.single_A.setText(QCoreApplication.translate("Spectroscopy", "A", None))
        self.single_B.setText(QCoreApplication.translate("Spectroscopy", "B", None))
        self.single_C.setText(QCoreApplication.translate("Spectroscopy", "C", None))
        self.single_D.setText(QCoreApplication.translate("Spectroscopy", "D", None))

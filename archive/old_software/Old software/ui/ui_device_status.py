...
class Ui_DeviceStatus:
    def setupUi(self, DeviceStatus):
        ...
        font_main_title.setFamilies(["Segoe UI"])
        ...
        self.spr_layout.setObjectName("spr_layout")
        self.spr_layout.setContentsMargins(8, 8, 8, 8)

        # SPR Title
        self.spr_title = QLabel(self.spr_frame)
        self.spr_title.setObjectName("spr_title")
        font_title = QFont()
        ...
        self.spr_device_layout.setObjectName("spr_device_layout")

        self.spr_device_label = QLabel(self.spr_frame)
        self.spr_device_label.setObjectName("spr_device_label")
        font_normal = QFont()
        font_normal.setFamilies(["Segoe UI"])
        ...
        self.pump_layout.setObjectName("pump_layout")
        ...
        self.pump_status.setObjectName("pump_status")
        ...
        self.operation_frame.setStyleSheet(
            "QFrame#operation_frame {\n"
            "    background-color: rgb(250, 250, 250);\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 5px;\n"
            "}",
        ...
        self.operation_modes_layout.setObjectName("operation_modes_layout")

        # Static Mode Label
        self.static_mode_label = QLabel(self.operation_frame)
        self.static_mode_label.setObjectName("static_mode_label")
        font_mode = QFont()
        font_mode.setFamilies(["Segoe UI"])
        font_mode.setPointSize(10)
        font_mode.setBold(False)
        self.static_mode_label.setFont(font_mode)
        self.static_mode_label.setStyleSheet(
            "QLabel {\n"
        ...
        self.flow_mode_label.setObjectName("flow_mode_label")
        ...
        self.not_supported_label.setObjectName("not_supported_label")
        self.not_supported_label.setFont(font_mode)
        self.not_supported_label.setStyleSheet(
            "QLabel {\n"
            "    color: rgb(100, 100, 100);\n"
            "    background-color: transparent;\n"
            "    padding: 3px 8px;\n"
        ...
        self.system_frame.setStyleSheet(
            "QFrame#system_frame {\n"
            "    background-color: rgb(250, 250, 250);\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 5px;\n"
        ...
        self.sensor_status_layout.setObjectName("sensor_status_layout")
        ...
        self.optics_status_layout.setObjectName("optics_status_layout")
        ...
        self.optics_status_label.setObjectName("optics_status_label")
        ...
        self.fluidics_status_layout.setObjectName("fluidics_status_layout")

        self.fluidics_label = QLabel(self.system_frame)
        self.fluidics_label.setObjectName("fluidics_label")
        ...
        self.fluidics_status_indicator.setObjectName("fluidics_status_indicator")
        self.fluidics_status_indicator.setMinimumSize(QSize(12, 12))
        self.fluidics_status_indicator.setMaximumSize(QSize(12, 12))
        self.fluidics_status_indicator.setStyleSheet(
            "QLabel {\n"
            "    background-color: rgb(200, 200, 200);\n"
            "    border-radius: 6px;\n"
            "}",
        ...
        spacer_before_support = QSpacerItem(
            20,
            20,
            QSizePolicy.Minimum,
            QSizePolicy.Expanding,
        ...
        self.support_link.setObjectName("support_link")
        font_link = QFont()
        font_link.setFamilies(["Segoe UI"])
        ...
        self.support_link.setStyleSheet(
            "QLabel {\n"
            "    color: rgb(46, 48, 227);\n"
            "    background-color: transparent;\n"
            "    padding: 12px 0px;\n"
    ...
    def retranslateUi(self, DeviceStatus):
        DeviceStatus.setWindowTitle(
            QCoreApplication.translate("DeviceStatus", "Device Status", None),
        )
        self.main_title.setText(
            QCoreApplication.translate("DeviceStatus", "Hardware Status", None),
        )
        self.spr_title.setText(
            QCoreApplication.translate("DeviceStatus", "Device", None),
        )
        self.spr_device_label.setText(
            QCoreApplication.translate("DeviceStatus", "SPR:", None),
        )
        self.spr_device_status.setText(
            QCoreApplication.translate("DeviceStatus", "Not Connected", None),
        )
        self.pump_label.setText(
            QCoreApplication.translate("DeviceStatus", "Pump:", None),
        )
        self.pump_status.setText(
            QCoreApplication.translate("DeviceStatus", "Not Connected", None),
        )
        self.spr_connect_btn.setText(
            QCoreApplication.translate("DeviceStatus", "Connect", None),
        )
        self.operation_title.setText(
            QCoreApplication.translate("DeviceStatus", "Operation", None),
        )
        self.static_mode_label.setText(
            QCoreApplication.translate("DeviceStatus", "Static", None),
        )
        self.flow_mode_label.setText(
            QCoreApplication.translate("DeviceStatus", "Flow", None),
        )
        self.not_supported_label.setText(
            QCoreApplication.translate("DeviceStatus", "Not Supported", None),
        )
        self.system_title.setText(
            QCoreApplication.translate("DeviceStatus", "System Status", None),
        )
        self.sensor_label.setText(
            QCoreApplication.translate("DeviceStatus", "Sensor:", None),
        )
        self.sensor_status_label.setText(
            QCoreApplication.translate("DeviceStatus", "Unknown", None),
        )
        self.optics_label.setText(
            QCoreApplication.translate("DeviceStatus", "Optics:", None),
        )
        self.optics_status_label.setText(
            QCoreApplication.translate("DeviceStatus", "Unknown", None),
        )
        self.fluidics_label.setText(
            QCoreApplication.translate("DeviceStatus", "Fluidics:", None),
        )
        self.fluidics_status_label.setText(
            QCoreApplication.translate("DeviceStatus", "Unknown", None),
        )
        self.support_link.setText(
            QCoreApplication.translate(
                "DeviceStatus",
                '<a href="https://www.affiniteinstruments.com/contact-us">Support</a>',
                None,
            ),
        )

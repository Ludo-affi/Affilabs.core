...
def create_time_plot(left_label: str, bottom_label: str = 'Time (seconds)', left_size: str = '11pt') -> pg.PlotWidget:
...
def add_channel_curves(plot: pg.PlotWidget, clickable: bool = False, width: int = 2):
    ...
    for i, color in enumerate(CHANNEL_COLORS):
        ...
        curve.setDownsampling(auto=True, method='subsample')  # 'subsample' better for smooth curves
...
def create_spectroscopy_plot(left_label: str, bottom_label: str, size: str = '10pt') -> pg.PlotWidget:

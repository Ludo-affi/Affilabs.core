...
from ui_styles import (
    ...
    label_style, title_style, scrollbar_style, group_box_style,
    text_edit_log_style, primary_button_style
)
...
class DiagnosticsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        status_group = self._create_group("⚙ System Status", [
    ...
    def _create_group(self, title, fields):
        ...
        for row, (label_text, attr_name) in enumerate(fields):
            ...
            label.setStyleSheet(label_style(12, color=Colors.SECONDARY_TEXT, weight=500))
            value = QLabel("N/A")
            value.setStyleSheet(label_style(12, color=Colors.PRIMARY_TEXT, weight=400, font_family=Fonts.MONOSPACE))

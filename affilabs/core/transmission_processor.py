...
class TransmissionProcessor:
    ...
    3. Apply baseline correction (method-dependent):
       ...
       [WARN]  CRITICAL: Polynomial correction removes OPTICAL wavelength dependence, NOT SPR physics!
    ...
    def process_single_channel(
        ...
        if verbose and wavelengths is not None:
            ...
            logger.info("\n[OK] Final transmission spectrum:")
            logger.info(
    ...
    def diagnose_spectral_tilt(
        ...
        off_spr_regions: list | None = None,
    ) -> dict:
    ...
    def calculate_transmission_qc(
        ...
        try:
            ...
            failed = (
                not qc["dip_detected"]
                or (qc["fwhm"] is not None and qc["fwhm"] >= 120.0)

...
class FMEATracker:
    ...
    def _check_scenarios(self, latest_event: FMEAEvent) -> None:
        ...
        for scenario in self.scenarios.values():
            ...
            if all(req in event_types_present for req in scenario.required_events):
                ...
                logger.warning(
                    f"[WARN] FMEA Scenario Detected: {scenario.name}\n"
    ...
    def mark_calibration_complete(self) -> None:
        ...
        logger.info("[OK] FMEA: Calibration phase marked complete")

    def mark_afterglow_validation_complete(self) -> None:
        """Mark afterglow validation as complete."""
        self.afterglow_validation_completed = True
        logger.info("[OK] FMEA: Afterglow validation marked complete")

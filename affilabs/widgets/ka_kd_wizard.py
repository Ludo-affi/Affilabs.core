...
from affilabs.ui.ui_ka_kd_wizard import Ui_KAKDWizardDialog
from affilabs.utils.logger import logger
from affilabs.utils.statistics import optimize_assoc, optimize_by_linear, optimize_rmax
from affilabs.utils.validator import NumericDelegate
from affilabs.widgets.message import show_message
from affilabs.widgets.table_item import CenteredQTableWidgetItem
...
class KAKDWizardDialog(QDialog):
        ...
        try:
            ...
            if no_data_flag:
                ...
                for i in range(len(rmax_0)):
                    ...
                    if (rmax_0[i] < 0) or (
                        abs((rmax_0[i] - rmax_0_avg) / rmax_0_avg) > 2
                    ):
    ...
    def _draw_plot(self):
        ...
        if self._result[ch]:
            ...
            fitted = [
                (self._result[ch]["ka"] * x) + self._result[ch]["kd"] for x in x_data
            ]

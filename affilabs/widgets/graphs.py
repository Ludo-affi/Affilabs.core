...
class SensorgramGraph(GraphicsLayoutWidget):
    ...
    **Navigation Philosophy:**
    ...
    - The CYCLE OF INTEREST REGION (between cursors) is the KEY GRAPH we're tracking
    - Cursors define what data appears in the detailed bottom graph (Cycle of Interest)

    Purpose:
    - Shows complete timeline of all collected data (navigational view)
    - Yellow/Red cursors mark region of interest for detailed view (thicker for easy interaction)

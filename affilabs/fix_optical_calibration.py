...
def main():
    ...
    try:
        ...
        if not optical_cal_path:
            print("[ERROR] No device detected or device manager not initialized")
        ...
        if not optical_cal_path.exists():
            print("[OK] No optical calibration file exists")
        ...
        if len(channels) < 4 or 'd' not in channels:
            ...
            if response == 'y':
                ...
                print("[ERROR] Calibration file NOT deleted")
            ...
            if led_intensities:
                ...
                print("   [OK] Ready for optimized LED calibration workflow")
            else:
                print("   [WARN]  No S-mode LED intensities saved")

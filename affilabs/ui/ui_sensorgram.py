...
"	border: 2px solid rgb(0, 0, 0);\n"
"}")
        self.segment_A_right.setChecked(False)
...
"	border: 2px solid rgb(255, 0, 81);\n"
"}")
        self.segment_B_right.setChecked(False)
...
"	border: 2px solid rgb(0, 174, 255);\n"
"}")
        self.segment_C_right.setChecked(False)
...
"	color: rgb(0, 230, 65);\n"
"	background: white;\n"
"	border: 2px solid rgb(0, 230, 65);\n"
"	border-radius: 6px;\n"
"	font-weight: 900;\n"
"}\n"
"QCheckBox:checked{\n"
"	background: rgb(0, 230, 65);\n"
"	color: white;\n"
"	border: 2px solid rgb(0, 230, 65);\n"
"}")
        self.segment_D_right.setChecked(False)
...
"}")
    ...
    def retranslateUi(self, Sensorgram):
        ...
        self.label_cycle_type.setText(QCoreApplication.translate("Sensorgram", u"Cycle Type:", None))
        ...
        self.current_note.setPlaceholderText(QCoreApplication.translate("Sensorgram", u"Cycle duration (minutes)", None))
        self.save_segment_btn.setText(QCoreApplication.translate("Sensorgram", u"Start Cycle", None))
        self.new_segment_btn.setText(QCoreApplication.translate("Sensorgram", u"Start at Live Time", None))

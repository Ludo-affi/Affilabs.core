...
from .styles import apply_channel_checkbox_style
...
class Ui_Sensorgram:
    def setupUi(self, Sensorgram):
        ...
        from ui.styles import Colors, get_groupbox_style, get_groupbox_title_font
        ...
        self.adjust_margins_btn.setObjectName("adjust_margins_btn")
        ...
        self.adjust_margins_btn.setText("Adjust Margins")

        self.horizontalLayout_sensor_header.addWidget(self.adjust_margins_btn)

        self.horizontalSpacer_header = QSpacerItem(
            40,
            20,
        ...
        self.groupBox_display_right.setObjectName("groupBox_display_right")
        ...
        self.segment_A_right.setObjectName("segment_A_right")
        ...
        self.segment_B_right.setObjectName("segment_B_right")
        ...
        self.segment_C_right.setObjectName("segment_C_right")
        ...
        self.segment_D_right.setObjectName("segment_D_right")
        ...
        self.loop_container.setObjectName("loop_container")
        self.loop_container.setStyleSheet(
            "QFrame#loop_container {\n"
            "    background-color: white;\n"
        ...
        self.loop_title.setObjectName("loop_title")
        ...
        self.loop_title.setStyleSheet("color: rgb(80, 80, 80); padding-bottom: 4px;")
        ...
        self.loop_diagram_container.setObjectName("loop_diagram_container")
        self.loop_diagram_container.setStyleSheet(
            "QFrame#loop_diagram_container {\n"
        ...
        self.loop_diagram.setStyleSheet("background:transparent; border: none;")
        ...
        self.loop_container_layout.addWidget(
            self.loop_diagram_container,
            0,
            Qt.AlignTop,
        )
        ...
        self.pump_flowrate_frame.setObjectName("pump_flowrate_frame")
        self.pump_flowrate_frame.setStyleSheet(
            "QFrame#pump_flowrate_frame {\n"
        ...
        self.pump_flowrate_title.setObjectName("pump_flowrate_title")
        ...
        self.pump_flowrate_title.setStyleSheet(
            "color: rgb(80, 80, 80); background: transparent; border: none;",
        )
        ...
        self.pump_current_label.setStyleSheet(
        ...
        self.pump_current_value.setObjectName("pump_current_value")
        ...
        self.pump_current_value.setStyleSheet(
            "QLabel {\n"
            "    background-color: white;\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 3px;\n"
        ...
        self.pump_current_unit.setObjectName("pump_current_unit")
        self.pump_current_unit.setText("μL/min")
        self.pump_current_unit.setMinimumWidth(45)
        self.pump_current_unit.setStyleSheet(
            "color: rgb(80, 80, 80); font-weight: normal;",
        )
        ...
        self.pump_set_value.setStyleSheet(
            "QLineEdit {\n"
            "    background-color: white;\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 3px;\n"
        ...
        self.pump_set_unit.setObjectName("pump_set_unit")
        self.pump_set_unit.setText("μL/min")
        self.pump_set_unit.setMinimumWidth(45)
        self.pump_set_unit.setStyleSheet("color: rgb(80, 80, 80); font-weight: normal;")
        ...
        self.pump_cycle_progress.setStyleSheet(
            "QLabel {\n"
            "    background-color: white;\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 3px;\n"
        ...
        self.pump_cycle_set.setObjectName("pump_cycle_set")
        ...
        self.pump_cycle_set.setStyleSheet(
            "QLineEdit {\n"
            "    background-color: white;\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 3px;\n"
        ...
        self.pump_stop_button.setObjectName("pump_stop_button")
        ...
        self.pump_refill_button.setObjectName("pump_refill_button")
        ...
        self.preset_functions_frame.setObjectName("preset_functions_frame")
        self.preset_functions_frame.setStyleSheet(
            "QFrame#preset_functions_frame {\n"
            "    background-color: rgb(250, 250, 250);\n"
            "    border: 1px solid rgb(200, 200, 200);\n"
            "    border-radius: 6px;\n"
            "    margin-top: 8px;\n"
        ...
        self.preset_title.setObjectName("preset_title")
        ...
        self.preset_title.setStyleSheet(
            "color: rgb(80, 80, 80); background: transparent; border: none;",
        )
        ...
        self.cycle_title.setStyleSheet("color: rgb(80, 80, 80); padding-bottom: 4px;")
        self.verticalLayout_3.addWidget(self.cycle_title)
        self.horizontalLayout_exp_time = QHBoxLayout()
        self.horizontalLayout_exp_time.setObjectName("horizontalLayout_exp_time")
        self.label_exp_time = QLabel(self.groupBox_4)
        self.label_exp_time.setObjectName("label_exp_time")
        ...
        self.exp_clock_settings.setObjectName("exp_clock_settings")
        ...
        self.horizontalLayout_cycle_type.setObjectName("horizontalLayout_cycle_type")
        self.label_cycle_type = QLabel(self.groupBox_4)
        self.label_cycle_type.setObjectName("label_cycle_type")
        ...
        self.current_cycle_type.addItem("")
        self.current_cycle_type.addItem("")
        self.current_cycle_type.setObjectName("current_cycle_type")
        ...
        self.horizontalLayout_cycle_duration.setObjectName(
            "horizontalLayout_cycle_duration",
        )
        self.label_cycle_duration = QLabel(self.groupBox_4)
        self.label_cycle_duration.setObjectName("label_cycle_duration")
        ...
        self.current_cycle_duration.addItem("")
        self.current_cycle_duration.addItem("")
        self.current_cycle_duration.setObjectName("current_cycle_duration")
        ...
        self.horizontalLayout_cycle_buttons.setObjectName(
            "horizontalLayout_cycle_buttons",
        )
        ...
        self.horizontalLayout_table_btn.setObjectName("horizontalLayout_table_btn")
        self.horizontalSpacer_table_left = QSpacerItem(
            40,
            20,
            QSizePolicy.Policy.Expanding,
            QSizePolicy.Policy.Minimum,
        ...
        self.open_table_btn.setObjectName("open_table_btn")
        ...
        sizePolicy2.setHeightForWidth(
            self.open_table_btn.sizePolicy().hasHeightForWidth(),
        )
        ...
        self.horizontalSpacer_table_right = QSpacerItem(
            40,
            20,
            QSizePolicy.Policy.Expanding,
            QSizePolicy.Policy.Minimum,
    ...
    def retranslateUi(self, Sensorgram):
        ...
        self.groupBox_display_right.setTitle(
            QCoreApplication.translate("Sensorgram", "Display", None),
        )
        self.segment_A_right.setText(
            QCoreApplication.translate("Sensorgram", "A", None),
        )
        self.segment_B_right.setText(
            QCoreApplication.translate("Sensorgram", "B", None),
        )
        self.segment_C_right.setText(
            QCoreApplication.translate("Sensorgram", "C", None),
        )
        self.segment_D_right.setText(
            QCoreApplication.translate("Sensorgram", "D", None),
        )
        ...
        self.cycle_title.setText(
            QCoreApplication.translate("Sensorgram", "Cycle Settings", None),
        )
        self.label_exp_time.setText(
            QCoreApplication.translate("Sensorgram", "Experiment time:", None),
        )
        self.exp_clock_settings.setText(
            QCoreApplication.translate("Sensorgram", "00h 02m 50s", None),
        )
        self.label_cycle_type.setText(
            QCoreApplication.translate("Sensorgram", "Type:", None),
        )
        self.label_cycle_duration.setText(
            QCoreApplication.translate("Sensorgram", "Duration (minutes):", None),
        )
        self.current_cycle_duration.setItemText(
            0,
            QCoreApplication.translate("Sensorgram", "2", None),
        )
        self.current_cycle_duration.setItemText(
            1,
            QCoreApplication.translate("Sensorgram", "5", None),
        )
        self.current_cycle_duration.setItemText(
            2,
            QCoreApplication.translate("Sensorgram", "15", None),
        )
        self.current_cycle_duration.setItemText(
            3,
            QCoreApplication.translate("Sensorgram", "30", None),
        )
        self.current_cycle_duration.setItemText(
            4,
            QCoreApplication.translate("Sensorgram", "60", None),
        )
        self.current_cycle_type.setItemText(
            0,
            QCoreApplication.translate("Sensorgram", "Auto-read", None),
        )
        self.current_cycle_type.setItemText(
            1,
            QCoreApplication.translate("Sensorgram", "Baseline", None),
        )
        self.current_cycle_type.setItemText(
            2,
            QCoreApplication.translate("Sensorgram", "Flow", None),
        )
        self.current_cycle_type.setItemText(
            3,
            QCoreApplication.translate("Sensorgram", "Static", None),
        )
        ...
        self.new_segment_btn.setText(
            QCoreApplication.translate("Sensorgram", "Data Table", None),
        )
        ...
        self.open_table_btn.setText(
            QCoreApplication.translate("Sensorgram", "Open Cycle Data Table", None),
        )

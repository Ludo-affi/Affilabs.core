    ...
    def run(self):
        ...
        while self.running and not self.stop_flag.is_set():
            try:
                ...
                if count % 20 == 0:
                    print(f"[OK] Acquired {count} spectrum sets ({count * 4} total spectra)")
...
class LiveDataWindow(QMainWindow):
    def __init__(self):
        ...
        print("[OK] Live Data Window initialized")
    ...
    def setup_ui(self):
        ...
        # Status
        self.status_label = QLabel("[OK] System calibrated and ready")
    ...
    def stop_acquisition(self):
        ...
        self.stop_btn.setEnabled(False)
        self.status_label.setText("[OK] System calibrated and ready")
        self.status_label.setStyleSheet("color: #28a745; padding: 10px;")
        ...
        print(f"[OK] Stopped - {total} spectra in {elapsed:.1f}s ({total/elapsed:.1f} Hz)")

...
Usage:
    from affilabs.utils.performance_profiler import PerformanceProfiler
...
class PerformanceProfiler:
    ...
    def print_stats(self, sort_by: str = "total", min_calls: int = 10) -> None:
...
def get_profiler() -> PerformanceProfiler:
    ...
    if _global_profiler is None:
        ...
        if enabled:
            logger.info("⏱ Performance profiling ENABLED - timing measurements active")
        else:
            logger.debug(
...
def print_hotspots(top_n: int = 10) -> None:

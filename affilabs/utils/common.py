...
# settings may not expose CONFIG_FILE; derive default config path if missing
try:
...
def update_config_file(data) -> None:
...
def export_segments(segments, path, value_list, ts_list) -> bool:
    import re
    from pathlib import Path

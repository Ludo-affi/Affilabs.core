...
def debug_bypass_calibration(app) -> None:
...
def debug_single_data_point(app) -> None:
...
def debug_start_simulation(app) -> None:
    ...
    try:
        ...
        logger.info(f"[OK] Data manager found: {app.data_mgr}")
...
def debug_simulate_calibration_success(app) -> None:
...
def debug_test_acquisition_thread(app) -> None:

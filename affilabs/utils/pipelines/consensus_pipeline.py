...
class ConsensusPipeline:
    ...
    def __init__(self, config=None):
        ...
        try:
            from affilabs.utils.peak_consensus import find_peak_consensus
    ...
    def find_resonance_wavelength(
        ...
        **kwargs
        ...
        try:
            ...
            from affilabs.utils.pipelines.centroid_pipeline import CentroidPipeline
        ...
        try:
            ...
            from affilabs.utils.spr_signal_processing import find_resonance_wavelength_fourier

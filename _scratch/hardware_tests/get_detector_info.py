...
def get_detector_info():
    ...
    try:
        ...
        print("Manufacturer: Phase Photonics")
        ...
        print("="*80)
        print("Min Integration Time: 0.1 ms (100 μs)")
        print("Max Integration Time: 5000 ms (5 seconds)")
        print("Typical Read Time: ~44 ms (22 ms integration + 22 ms USB)")
        ...
        print("COMMUNICATION")
        print("="*80)
        print("Interface: USB (FTDI chip)")
        print("DLL: Sensor64bit.dll (OEM recommended)")
        print("Driver: D2XX (FTDI direct driver)")

...
class Ui_KNX2(object):
    def setupUi(self, KNX2):
        if not KNX2.objectName():
            KNX2.setObjectName(u"KNX2")
        KNX2.resize(260, 80)
        ...
        KNX2.setFont(font)
        KNX2.setStyleSheet(u"QGroupBox#KnxBox::title{\n"
"\n"
...
"}")
        ...
        self.KnxBox.setObjectName(u"KnxBox")
        ...
        self.KnxBox.setStyleSheet(u"QGroupBox#KnxBox::title{\n"
"\n"
"	margin: 0px 5px 0px 5px;\n"
"	color: rgb(255, 255, 255);\n"
"	background-color:rgb(46, 48, 227);\n"
...
"}")
    ...
    def retranslateUi(self, KNX2):
        KNX2.setWindowTitle(QCoreApplication.translate("KNX2", u"Form", None))
        self.KnxBox.setTitle(QCoreApplication.translate("KNX2", u"Kinetics", None))
#if QT_CONFIG(tooltip)
        self.disconnect_btn.setToolTip(QCoreApplication.translate("KNX2", u"Disconnect KNX2", None))
#endif // QT_CONFIG(tooltip)
        self.disconnect_btn.setText("")
#if QT_CONFIG(tooltip)
        self.shutdown_btn.setToolTip(QCoreApplication.translate("KNX2", u"Power Off KNX2", None))
#endif // QT_CONFIG(tooltip)
        self.shutdown_btn.setText("")
        self.temp1.setText(QCoreApplication.translate("KNX2", u"##.#", None))
        self.label_7.setText("")
        self.label_8.setText(QCoreApplication.translate("KNX2", u"<html><head/><body><p>Temperature:</p></body></html>", None))
    # retranslateUi

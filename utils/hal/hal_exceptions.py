...
class HALError(Exception):
    ...
    def __init__(self, message: str, device_info: Optional[dict[str, Any]] = None) -> None:
        """
...
class HALConnectionError(HALError):
    ...
    def __init__(self, message: str, port: Optional[str] = None, device_info: Optional[dict[str, Any]] = None) -> None:
        """
...
class HALTimeoutError(HALError):
    ...
    def __init__(self, message: str, timeout_duration: Optional[float] = None, device_info: Optional[dict[str, Any]] = None) -> None:
        """
...
class HALConfigurationError(HALError):
    ...
    def __init__(self, message: str, invalid_config: Optional[dict[str, Any]] = None, device_info: Optional[dict[str, Any]] = None) -> None:
        """
...
class HALIncompatibleDeviceError(HALError):
    ...
    def __init__(self, message: str, expected_device: str, detected_device: Optional[str] = None, device_info: Optional[dict[str, Any]] = None) -> None:
        """
...
class HALOperationError(HALError):
    ...
    def __init__(self, message: str, operation: str, device_info: Optional[dict[str, Any]] = None) -> None:
        """

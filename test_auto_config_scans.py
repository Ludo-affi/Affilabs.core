...
def test_auto_config():
    ...
    print(f"   detector.calculate_optimal_scans(int_ms, budget_ms)")
    print(f"   detector.set_optimal_scans(int_ms, budget_ms)")
    print(f"   detector.get_num_scans()")

...
print(f"Detector: Phase Photonics ST00012")
...
print(f"Detector: PhasePhotonics (type string)")
...
print(f"Detector: Ocean Optics USB4H14526")
...
print(f"Detector: Unknown/Default")
...
print(f"Detector: Phase Photonics ST00012 (with manual override)")
...
print(f"  Pixels: 3648")
print(f"  Resolution: ~0.044 nm/pixel")
...
print(f"  Pixels: 1848")
print(f"  Resolution: ~0.085 nm/pixel")
...
print(f"✓ Alpha scaled with pixel count (4500 vs 9000)")

...
axes[0,0].set_title('OLD SENSOR: Raw Spectra (SATURATED!)', fontsize=12, fontweight='bold')
...
axes[2,0].set_title(f'OLD SENSOR: Transmission\nRange: {trans_old.min():.3f} to {trans_old.max():.3f}',
...
axes[0,1].set_title('NEW SENSOR: Raw Spectra (SATURATED!)', fontsize=12, fontweight='bold')
...
axes[2,1].set_title(f'NEW SENSOR: Transmission\nRange: {trans_new.min():.3f} to {trans_new.max():.3f}',
                   fontsize=12, fontweight='bold')
...
plt.suptitle('TRANSMISSION DIAGNOSTIC - SATURATION ISSUE',

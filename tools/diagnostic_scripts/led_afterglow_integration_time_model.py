...
def main():
    ...
    print("  • Characterize all 4 channels (A, B, C, D)")
    ...
    integration_times_ms = [5, 10, 20, 50, 100]  # Skip 1-2ms (too short for good fits)
    cycles = 5
    ...
    try:
        ...
        json_file = (
            output_dir / f"led_afterglow_integration_time_models_{timestamp}.json"
        )

...
def test_rankbatch_simple(port_name="COM5"):
    ...
    print("=" * 60)
    print("Configuration:")
    print("  LED A: 100 intensity")
    print("  LED B: 150 intensity")
    print("  LED C: 200 intensity")
    print("  LED D: 250 intensity")
    print("  Settle: 250ms")
    print("  Dark: 250ms")
    print("  Cycles: 10")
    print("  Expected time per cycle: ~2 seconds")
    print("  Total expected time: ~20 seconds")
    print("=" * 60)
    print()

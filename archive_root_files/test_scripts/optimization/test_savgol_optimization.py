...
def main():
    ...
    print("   🎯 TARGET: <16.6 pm (10x from 166 pm raw)")
    ...
    for window_length in window_lengths:
        for polyorder in polyorders:
            ...
            if result is not None:
                ...
                print(
                    f"Window={window_length:3d}, Poly={polyorder}, P2P={result['peak_to_peak_pm']:7.3f} pm, Std={result['std_pm']:6.3f} pm",
                )

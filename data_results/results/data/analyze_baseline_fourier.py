...
print(
    f"   Wavelength range: {df['wavelength_nm'].min():.1f} - {df['wavelength_nm'].max():.1f} nm",
)
...
print("Current performance baseline needed...")
...
for sg_win in sg_window_values:
    for sg_poly in sg_poly_values:
        ...
        try:
            ...
            print(
                f"   SG Window={sg_win:>2}, Poly={sg_poly}: std={std:.4f}, p2p={p2p:.4f}",
            )
        except:
            pass
...
print("\n📌 CURRENT SETTINGS:")
print("   FOURIER_ALPHA = 9000")
print("   Step 5 Window = 50")
print("   Step 6 Window = 50")
print("   SG Window = 11, Poly = 3")
...
print("\n💡 NEXT STEPS:")
print("1. Update settings.py with optimized values")
print("2. Test on all 4 channels to verify consistency")
print("3. Run 5-minute baseline with new settings")
print("4. Target: <2 RU peak-to-peak (0.006 nm)")

...
if result:
    ...
    logger.info(f"Separation: {abs(s_pos_servo - p_pos_servo)} servo units (circular polarizer)")
    logger.info(f"Extinction Ratio: {extinction_ratio:.2f}% (sensor-specific reference)")
    logger.info("\nRefinement stages:")

...
def test_hardware_averaging():
    ...
    try:
        ...
        print("  Expected: ~352ms (8 scans × 44ms)")
        ...
        print("  Expected: ~198ms (8 × 22ms integration + 22ms transfer)")
        ...
        if mean_diff < 10:
            print("  ✓ Results match (difference < 10 counts)\n")
        else:
            print("  ⚠ Large difference - verify averaging is working correctly\n")

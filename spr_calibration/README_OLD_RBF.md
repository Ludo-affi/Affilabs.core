...
# - Calibrated servo polarizer (see servo_polarizer_calibration/)

# Firmware requirement:
# - Multi-LED command support (lm:A,B,C,D) introduced in V1.9
# - Batch intensity control for optimized calibration
# - Earlier firmware versions are NOT supported

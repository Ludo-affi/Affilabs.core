...
def test_pre_arm_capability():
    ...
    print(f"Detector already opened by factory")
    ...
    try:
        ...
        print(f"  Expected: ~50ms × 1.93 = ~96ms")
        ...
        print(f"  Expected: ~50ms × 1.93 = ~96ms (if 50ms persisted)")
        ...
        print(f"  Expected: ~10ms × 1.93 = ~19ms")
        ...
        print(f"  Expected ratio (50ms / 10ms): 5.0x")
